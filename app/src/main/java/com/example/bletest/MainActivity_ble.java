...
public class MainActivity_ble extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handler.postDelayed(new Runnable() {
            @Override
            public void run() {
                if (ActivityCompat.checkSelfPermission(MainActivity_ble.this, Manifest.permission.BLUETOOTH_SCAN) != PackageManager.PERMISSION_GRANTED) {
                    ;
                }
    ...
    class MyScancallback extends ScanCallback {
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            count += 1;
            if (result.getDevice() == null) return;
            if (ActivityCompat.checkSelfPermission(MainActivity_ble.this, Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED) {
                ;
            }
            //Log.d("scanShow", result.getDevice().getAddress());
